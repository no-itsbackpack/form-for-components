    ...
    return (
      <div>
        <Form for={this.state.user} onChange={this.handleChange}>
          <div>Name: <Field name="name" autoFocus /></div>
          <div>Phone: <Field name="phone" /></div>
          <div>Email: <Field name="email" /></div>
          <div>Access: <Field name="access" /></div>
          <div>Favorite color: <Field name="favoriteColor" /></div>
          <div>Employment: <Field name="employment" /></div>
